        ...
        <div class="step-content">
          ...
          <div class="step-item step-item1"
            ...
            <div class="scaning">
              ...
              <p>{{$t('trans0334').replace('%s',customerName)}}</p>
            </div>
          </div>
          <!-- 扫描结果 -->
          <div class="step-item step-item1"
            ...
            <div class="scan-empty"
                 v-show="!nodes.length">
              <p>{{$t('trans0181').replace('%s',customerName)}}</p>
              <span class="btn-help"
                    @click.stop="openHelpDialog">{{$t('trans0128')}}</span>
              <div class="button-container">
                <button @click="go2Step(2)"
      ...
      <div class="info-container"
        ...
        <div class="step-content">
          <div class="step-item step-item2">
            <div class="success"
                 v-if="added">
              <img src="../../../../../base/src/assets/images/icon/ic_success.png"
                   alt="" />
              <p>{{$t('trans0192')}}</p>
              <div class="button-container">
            ...
            <div class="fail"
                 v-if="!added">
              <img src="../../../../../base/src/assets/images/icon/ic_fail.png"
                   alt="" />
              <p>{{$t('trans0248')}}</p>
              <span class="btn-help"
                    @click.stop="openHelpDialog">{{$t('trans0128')}}</span>
    ...
    <m-modal class="modal"
      ...
      <div class="modal-content">
        <div class="help-dialog-content">
          <div>
            <p>{{$t('trans0234').replace('%s',modelName)}}</p>
            <p>{{$t('trans0160')}}</p>
            <p>{{$t('trans0158')}}</p>
            <p>{{$t('trans0175')}}</p>
            <p>{{$t('trans0330')}}</p>
...
export default {
  data() {
    ...
    if (process.env.CUSTOMER_CONFIG.routers.Bee) {
      Routers.push({
        ...
        image: require('../../../../../base/src/assets/images/img_bee.png'),
        powerOnImage: require('../../../../../base/src/assets/images/img_power_on_bee.jpg'),
        lampImage: require('../../../../../base/src/assets/images/pic_node_1_redlight.jpg'),
        tipImage: require('../../../../../base/src/assets/images/img_add_plug_bee.jpg'),
    ...
    if (process.env.CUSTOMER_CONFIG.routers.M2) {
      Routers.push({
        ...
        image: require('../../../../../base/src/assets/images/img_m2.png'),
        powerOnImage: require('../../../../../base/src/assets/images/pic_router_m2.jpg'),
        lampImage: require('../../../../../base/src/assets/images/img_power_on_m2.jpg'),
        tipImage: require('../../../../../base/src/assets/images/img_add_plug_m2.jpg'),
        sn: RouterSnModel.M2
      });
    }
    return {
  ...
  computed: {
    ...
    customerName() {
      return process.env.CUSTOMER_CONFIG.title;
    },
    modelName() {
      return process.env.CUSTOMER_CONFIG.routers.M2.shortName;
    }
  },
  methods: {
    openHelpDialog() {
    ...
    getNodeImg(node) {
      ...
      if (id === this.RouterSnModel.M2) {
        return require('../../../../../base/src/assets/images/img_m2.png');
      }
      if (id === this.RouterSnModel.Bee) {
        return require('../../../../../base/src/assets/images/img_bee.png');
      }
      return require('../../../../../base/src/assets/images/icon/ic_default_router.png');
    },
    getNodeName(node) {
      const id = node.sn.slice(0, 2);
...
.type-container {
  ...
  .circle-animation {
    position: relative;
    background: url(../../../../../base/src/assets/images/add_node_tip_bj.png)
      no-repeat center;
    background-size: 100%;
    width: 340px;
    margin: 0 auto;

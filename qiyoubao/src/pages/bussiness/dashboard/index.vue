  ...
  <div class="dashboard customized">
    <div class="net-info">
      <div class="device inner">
        <div class="card"
             @click="forward2page('/dashboard/devices/primary')">
          <div class="row-1">
...
export default {
  ...
  computed: {
    ...
    appIconSrc() {
      const ispName = process.env.CUSTOMER_CONFIG.deviceID.toLowerCase();
      const img = require(`@/assets/images/customer/${ispName}/ic_launcher.png`);
      return img;
    }
  },
  mounted() {
        ...
        .mobile-icon-wrapper {
          ...
          .btn-icon {
            ...
            .sub {
              ...
              overflow: hidden;
              &.connected {
                background: url(#{$img_folder}/icon/ic_mobile_connected.svg)
                  center no-repeat;
                background-size: contain;
              }
              &.unconnected {
                background: url(#{$img_folder}/icon/ic_mobile_unconnect.svg)
                  center no-repeat;
                background-size: contain;
              }
            }

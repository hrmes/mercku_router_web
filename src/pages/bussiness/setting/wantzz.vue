              ...
              <m-form v-if="isPppoe"
                ...
                <m-form-item prop='password'>
                  <m-input :label="$t('trans0156')"
                           :placeholder="$t('trans0321')"
                           type='password'
                           v-model="pppoeForm.password"></m-input>
                </m-form-item>
              </m-form>
            </div>
            <!-- 开关选择动态 ip 对应表单 -->
              ...
              <m-form>
                <m-form-item>
                  <m-radio-group class="radio-group"
                                 direction="vertical"
                                 :options="dnsOptions"
                                 v-model="autodns.dhcp"></m-radio-group>
                </m-form-item>
                <!-- 手动配置 -->
                <div class="man-show"
                     v-if="autodns.dhcp">

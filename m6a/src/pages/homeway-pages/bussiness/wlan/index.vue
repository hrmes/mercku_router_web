...
import { HomewaySnModel } from '../../../../../../base/src/util/constant';
...
export default {
  ...
  methods: {
      ...
      this.$http.getRouter()
        ...
        .then(() => {
          switch (this.modelVersion) {
            case HomewaySnModel.Homeway_M6a:
              break;
            case HomewaySnModel.Homeway_230v:
              this.currentRouter = '230v';
              break;
            case HomewaySnModel.Homeway_PoE_1:
              this.currentRouter = 'PoE';
              break;
            case HomewaySnModel.Homeway_PoE_2:
              this.currentRouter = 'PoE';
              break;
            default:
              break;
    ...
    prepared(router) {
      ...
      router === '230v' ? this.$router.push({ path: '/wlan/wifisetting-230v' }) : this.$router.push({ path: '/wlan/wifisetting' });
    }
  }
};
</script>

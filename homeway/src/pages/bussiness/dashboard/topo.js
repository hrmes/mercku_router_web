...
import picWwaxGateway from '../../../assets/images/icon/ic_homeway_gateway.png';
import picWwaxGood from '../../../assets/images/icon/ic_homeway_excellent.png';
import picWwaxBad from '../../../assets/images/icon/ic_homeway_fair.png';
import picWwaxOffline from '../../../assets/images/icon/ic_homeway_offline.png';
...
function genNodes(gateway, green, red, offline) {
  const picModelColorMap = {
    [CONSTANTS.RouterSnModel.homeway]: {
      [Color.good]: picWwaxGood,
      [Color.bad]: picWwaxBad,
      [Color.offline]: picWwaxOffline
    }
  };
